...
const CACHE = 'hospital-roster-builder-v23';
const SHELL = [
  './', './login.html', './create-password.html', './index.html', './staff.html', './roster.html',
  './history.html', './about.html', './style.css', './config.js', './supabase-client.js',
  './script.js', './auth.js', './auth-guard.js', './create-password.js', './pwa-install.js',
