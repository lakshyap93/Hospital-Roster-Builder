...
const CACHE = 'hospital-roster-builder-v26';
const SHELL = [
  '/', '/login', '/create-password', '/staff', '/roster',
  '/history', '/about', './style.css', './config.js', './supabase-client.js',
  './script.js', './auth.js', './auth-guard.js', './env-router.js', './create-password.js', './pwa-install.js',
